class SoundButtons extends Phaser.GameObjects.Container
{
    constructor(config)
    {
        ...
        this.musicButton =new ToggleButton ({scene:this.scene,backKey:'toggleBack',onIcon:'musicOn',offIcon:'musicOff',event:G.TOGGLED_MUSIC});
        this.sfxButton =new ToggleButton ({scene:this.scene,backKey:'toggleBack',onIcon:'sfxON',offIcon:'sfxOff',event:G.TOGGLED_SOUND,y:25});
